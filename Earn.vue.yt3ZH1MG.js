...
import {
  ...
  W as Q,
  I as tt
} from "./entry.B9rEuBGC.js";
import {
  u as et
} from "./settings.cSFbbKuc.js";
import {
  f as st
} from "./index.es.CRTIByZE.js";
const ot = "" + globalThis.__publicAssetsURL("images/rocket.png"),
  ...
  Ot = S({
      ...
      setup(y) {
          ...
          function p(s) {
              (T.settings.haptic && st().impactOccurred("medium"), a.earn(), L(s), d(s))
          }
          const n = {
                  scale: 1,
                  translateZ: 0,
